...
public interface IReader {
	...
	public String getJasonStathamLounge();
	public String getTomHanksLounge();
	public String getTeslaCompany();
	public String getRenaultCompany();
	public String getHondaCompany();
	public String getDealFL93431();
	public String getPostmanLimitedCompany();
